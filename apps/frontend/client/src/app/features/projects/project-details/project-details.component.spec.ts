...
//       progressPercentage: 0, // recalculated by mapToProjectDetails()
...
//       expect(component.project().hoursLogged).toBe(50);
...
//       expect(component.remainingHours()).toBe(50);
//     });
...
//       httpMock
//         .expectOne(`/api/projects/${projectId}`)
//         .flush(makeProjectDetailResponse({ budgetHours: 10, hoursLogged: 3000 }));
//       httpMock.expectOne(`/api/tasks/project/${projectId}`).flush([]);
