...
//     // sets a test secret key for signing the JWT tokens, ensuring that the JwtService can
// generate
...
//     // this test checks the extractEmail method to ensure that it correctly extracts the email
// claim
...
//     // this test checks the isTokenValid method to ensure that it returns true for a valid JWT
// token
...
//     // validates
//     // the token against the provided email and does not allow tokens to be considered valid if
// the
...
//     // verifying that the method correctly identifies valid tokens as not expired, allowing them
// to
//     // be
//     // used for authentication and access to protected resources until they reach their
// expiration
//     // time
//     String token = jwtService.generateToken(user, 1);
