...
//it has all the functions for authentication, registration, email verification, password reset, and logout
//note some of these may be integrated after Demo 1 depending on time, 
//but I have them here for completeness and to show the full implementation of authentication features
@Service
