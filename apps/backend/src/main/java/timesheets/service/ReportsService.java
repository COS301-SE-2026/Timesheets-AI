...
// // service for generating various reports, currently implements productivity report generation
// based
...
// // summarize the data, and return a structured response that can be used by the frontend to
// display
// // the report
...
//   // we could inject other repositories here as needed, for example if we want to join with
// projects
...
//         entries
//             .stream() // calculate the week for each entry based on start time, then group by
// that
//             // week
//             .collect(
