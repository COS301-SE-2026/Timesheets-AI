...
//we will be using Redis for this because it's fast and supports TTL (time to live) which is perfect for expiring blacklisted tokens after their natural expiration time.
@Service
