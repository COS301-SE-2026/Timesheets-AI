...
//     long durationMinutes = ChronoUnit.MINUTES.between(startedAt, now); // I am calculating how
// long

//     if (activeTimer.getPausedDurationSeconds() != null) {
//       durationMinutes -= (activeTimer.getPausedDurationSeconds() / 60);
//     } // so this should subtract the paused duration to see the actual time- I made the mistake
// of
...
//   // okay so when the page is refreshed it should still have their timer running, so that is how
// I
//   // am doing it
