...
public class CreatedTimeEntryResponse {
    ...
    public CreatedTimeEntryResponse(UUID id, SimpleProject project, SimpleTask task, LocalDate date, LocalTime startTime, LocalTime endTime, Integer durationMinutes, String status) {
        this.id = id;
