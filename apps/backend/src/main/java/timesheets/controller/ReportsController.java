...
//currently includes an endpoint for generating a productivity report based on time entries for a given user and date range
@RestController
...
public class ReportsController {
    ...
    @GetMapping("/productivity") //endpoint for generating productivity report, accepts from and to dates as query parameters
    public ResponseEntity<ProductivityReportResponse> getProductivityReport(
        ...
        ProductivityReportResponse report = reportsService.generateProductivityReport(request, currentUser);
