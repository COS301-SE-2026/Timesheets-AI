...
// // currently includes an endpoint for generating a summary of insights based on time entries for
// a
// // given user
...
//             request,
//             currentUser); // call service to generate insights summary based on time entries for
// the
