...
// I created this filter to intercept incoming HTTP requests and check for a valid JWT token in the
...
// filter for JWT authentication, checks for valid token and sets authentication in security context
// if valid
@Component
