...
// // okay so I am going to use the method of allowing Spring to parse through the method names to
// get
// // an SQL query
...
//   @Query(
//       "SELECT COUNT(t) FROM TimerSession t WHERE t.workspaceMemberId = :memberId AND t.isRunning
// = true")
...
//   // this function will first find the workspaces where the workspaceID is a member and then find
// if
