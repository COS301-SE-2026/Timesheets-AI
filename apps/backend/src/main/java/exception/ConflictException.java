...
// I am doing this such that the frontend can handle things properly, remember how proper error
// codes help frontend and users
public class ConflictException extends RuntimeException {
  ...
  public ConflictException(String message, String userMessage, UUID activeTimerId) {
    ...
    super(
        message); // remember inheritance so the parent class RuntimeException class is the one that
    // is called,
