...
def calculate_productivity_score(
    ...
    total_actual_hours = sum(task.actual_hours for task in tasks)
    ...
    return {
        ...
        "description": f"Productivity score calculated successfully. You have completed {score}% tasks during the specified period.".format(task_count),
    }
def save_productivity_insight(
        db: Session,
        workspace_member_id: uuid.UUID,
        result: dict) -> AIInsight:
    insight = AIInsight(
