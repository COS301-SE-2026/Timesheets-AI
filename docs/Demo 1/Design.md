...
<p align="center">
  <img src="../../assets/images/Wireframe #1.png" alt="Momently" width="260" />
</p>
...
<p align="center">
  <img src="../../assets/images/Wireframe #2.png" alt="Momently" width="260" />
</p>
...
![Wireframe 3: Log Time](../../assets/images/Wireframe__3.png)
...
The screen uses the standard authenticated shell: fixed left sidebar + full-width content area. Within the content area the layout is:
...
| Type badges | Coloured pill badges (DEVELOPMENT in blue, MEETING in teal, DOCUMENTATION in amber, DESIGN in orange, BREAK in grey) | Colour-coded type badges allow the user to pattern-scan by type without reading every word. Colours are drawn from the semantic palette extended for entry types. |
...
<p align="center">
  <img src="../../assets/images/Wireframe #4.png" alt="Momently" width="260" />
</p>
...
| Type | Colour |
|---|---|
| DEVELOPMENT | Blue (`#BFD4F4` bg, `#0F4C91` text) |
| MEETING | Teal |
| DOCUMENTATION | Amber (`#F0D49A` bg) |
| DESIGN | Orange (`#E07830` bg, white text) |
| BREAK | Light grey |
